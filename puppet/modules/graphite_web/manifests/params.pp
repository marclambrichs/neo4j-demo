class graphite_web::params {
  ...
  $config_graphite_root                   = '/var/graphite'
  $config_index_file                      = '/var/graphite/storage/index'
  ...
  $config_storage_dir                     = '/var/graphite/storage'
  ...
  $db_file                                = '/usr/share/graphite/webapp/graphite.db'
